...
<div class="content container" id="content">
	...
	<table class="table">
		<tbody>
			<tr>
				<th>제목</th>
				<td><input type="text" name="title" id="title" placeholder="제목"  class="form-control" autofocus required></td>
			</tr>
			<tr>
				<th>내용</th>
	...
	<div class="btn-group">
		...
		<input type="reset" name="reset-btn" class="btn btn-info" value="글 취소">
